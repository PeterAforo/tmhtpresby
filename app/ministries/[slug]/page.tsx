...
const MINISTRIES_DATA: Record<string, {
  ...
  ypg: {
    ...
    description: "The Young People's Guild is a vibrant fellowship for teenagers and young people. We equip youth to navigate life with faith, purpose, and community through weekly gatherings, mentorship, and outreach programmes.",
    ageGroup: "Ages 13–25",
